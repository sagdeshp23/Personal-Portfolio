...
const PM=[
  ...
  {t:'Ticket Hierarchy Report',co:'T-Systems · 2022–2024',col:'var(--accent-automate)',ic:'account_tree',tags:['Power BI','DAX','T-Systems'],desc:'A drillable weekly report on a data model spanning 7–8 tables with a five-level hierarchy — Registered Projects → Services → Sub-Services → Tickets → Ticket Category. Segmented by PU, BA, and BU; services classified by Level and Bundle. Gave leadership a structured, drillable view of ticket activity across the full organisational tree.',tech:['Power BI','DAX Measures','Power Query (M)','Data Modelling','T-Systems'],pts:['5-level drillable hierarchy: Projects → Services → Sub-Services → Tickets → Categories','Segmented by PU, BA, BU with service classification by Level and Bundle','Leadership visibility into ticket activity across organisational tree','Multi-table data model with optimised Power Query transformations','Interactive drill-through capabilities for detailed analysis']},
  {t:'DevOps Toolchain License Report',co:'T-Systems · 2022–2024',col:'var(--accent-automate)',ic:'key',tags:['Power BI','Compliance','T-Systems'],desc:'Tracks active users, maximum seats, and free capacity across 7–8 DevOps tools — with a dedicated view for the playground instance and a flag identifying licenses unused for 6+ months. Gave the project full visibility over spend and compliance in one place.',tech:['Power BI','DAX Measures','Power Query (M)','Data Modelling','T-Systems'],pts:['Tracks across 7-8 DevOps tools: active users, max seats, free capacity','Dedicated playground instance view','Identifies licenses unused for 6+ months','Full spend and compliance visibility in single dashboard','Automated unused license flagging for cost optimisation']},
  {t:'ServiceNow SLA Reaction Report',co:'T-Systems · 2022–2024',col:'var(--accent-automate)',ic:'timer',tags:['Power BI','ServiceNow','T-Systems'],desc:'Measures full ticket lifecycle time: Open → In Progress → Pending → Closed. Surfaced SLA compliance gaps and gave team leads a factual, data-driven basis for performance conversations.',tech:['Power BI','DAX Measures','Power Query (M)','ServiceNow Integration','T-Systems'],pts:['Full ticket lifecycle tracking: Open → In Progress → Pending → Closed','SLA compliance gap identification','Team lead performance metrics and conversations','Data-driven factual basis for escalations','ServiceNow real-time data refresh']},
  {t:'Adastra BI & Allocation Reporting Suite',co:'Adastra · 2025',col:'var(--accent-bi)',ic:'bar_chart',tags:['Power BI','Dataverse','Adastra'],desc:'Advanced Allocation Report with complex business logic, multi-source data transformations, and performance-optimised modelling — used directly by management for resource planning. Includes automated Bench Reporting with dynamic parameters, bookmarks, and DAX drilldowns embedded live inside the enterprise app. KPI dashboards with real-time DAX metrics, conditional formatting, and Power Query transformations from Dataverse, SharePoint, and third-party APIs.',tech:['Power BI','DAX Measures','Power Query (M)','Dataverse','Adastra'],pts:['Advanced Allocation Report for management resource planning','Automated Bench Reporting with dynamic parameters and bookmarks','DAX drilldowns embedded in enterprise app','Real-time KPI dashboards with conditional formatting','Multi-source data transformations from Dataverse, SharePoint, APIs']},
  {t:'AI Assistance — Upload to Autofill',co:'Adastra · 2025',col:'var(--accent-copilot)',ic:'auto_awesome',tags:['Power Apps','Azure OpenAI','Dataverse'],desc:'A single Canvas App screen handling the entire document-to-data pipeline: upload document → Power Automate triggers Azure OpenAI extraction → confidence scoring routes for auto-fill or manual review.',tech:['Canvas Apps','Azure OpenAI','Power Automate','Dataverse','PCF Controls'],pts:['Single-screen UX for the full upload-to-fill pipeline — no page navigation required','GPT-4.1 extracts structured data from unstructured documents precisely','High confidence → auto-fill; low confidence → flagged for human review','PCF controls for enhanced file upload experience with preview support','Zero manual data entry for standard documents in production']},
  {t:'Allocation Management App',co:'Adastra · 2025',col:'var(--accent-apps)',ic:'assignment_turned_in',tags:['Power Apps','Dataverse','Power Automate'],desc:'Single-handedly built an end-to-end Power Platform solution for allocation request management. Features multi-stage approval process with security role-based routing, Adaptive Card notifications in Teams, approval timeline, audit history, alert popups, and HTML-powered UI components — all built in Canvas + Model-Driven Apps on Dataverse. Output feeds directly into the Adastra Allocation Report.',tech:['Canvas Apps','Model-Driven Apps','Dataverse','Power Automate','Adaptive Cards','HTML Controls','Security Roles'],pts:['End-to-end allocation request management solution','Multi-stage approval with security role-based routing','Adaptive Card notifications in Microsoft Teams','Approval timeline and audit history tracking','Alert popups and HTML-powered UI components','Feeds Adastra Allocation Report as data source']}
];
